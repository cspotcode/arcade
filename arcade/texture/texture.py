...
from arcade.hit_box_utils import fast_points_to_points, points_to_fast_points
...
class Texture:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self._hit_box_points = points_to_fast_points(hit_box_points or self._calculate_hit_box_points())
    ...
    def _new_texture_transformed(self, transform: Type[Transform]) -> "Texture":
        ...
        :return: New texture
        """
        points = transform.transform_hit_box_points(fast_points_to_points(self._hit_box_points))
        texture = Texture(
            self.image_data,
