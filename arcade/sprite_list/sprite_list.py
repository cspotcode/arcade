...
class SpriteList(Generic[SpriteType]):
    ...
    def draw(
        ...
        blend_function: Union[Tuple[int, int], Tuple[int, int, int, int], None]=None
    ) -> None:
        """
    ...
    def _grow_sprite_buffers(self) -> None:
        ...
        if self._initialized:
            self._sprite_pos_buf.orphan(double=True) # type: ignore [union-attr]
            self._sprite_size_buf.orphan(double=True) # type: ignore [union-attr]
            self._sprite_angle_buf.orphan(double=True) # type: ignore [union-attr]
            self._sprite_color_buf.orphan(double=True) # type: ignore [union-attr]
            self._sprite_texture_buf.orphan(double=True) # type: ignore [union-attr]
